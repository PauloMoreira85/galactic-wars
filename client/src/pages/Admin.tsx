...
const EMPTY: AdInput = { title: "", imageUrl: "", linkUrl: "", caption: "", active: true, sortOrder: 0 };
...
export function Admin() {
  ...
  function edit(ad: AdminAd) {
    setEditingId(ad.id);
    setForm({ title: ad.title, imageUrl: ad.imageUrl, linkUrl: ad.linkUrl, caption: ad.caption ?? "", active: ad.active, sortOrder: ad.sortOrder });
    ...
    <div className="app" style={{ display: "block", padding: 24, maxWidth: 900, margin: "0 auto" }}>
      ...
      <div className="panel">
        ...
        {ads.length === 0 ? <div className="roid-count">Nenhum anúncio ainda.</div> : (
          <table>
            <thead><tr><th>Banner</th><th>Título</th><th>Ordem</th><th>Cliques</th><th>Status</th><th></th></tr></thead>
            <tbody>
              {ads.map((ad) => (
