...
INSERT INTO "new_GalaxyState" ("cgPlanetId", "flag", "fundCarbonum", "fundMetalium", "fundPlutonium", "galaxy", "mdPlanetId", "mePlanetId", "mgPlanetId", "name", "taxRate") SELECT "cgPlanetId", "flag", "fundCarbonum", "fundMetalium", "fundPlutonium", "galaxy", "mdPlanetId", "mePlanetId", "mgPlanetId", "name", "taxRate" FROM "GalaxyState";
DROP TABLE "GalaxyState";
ALTER TABLE "new_GalaxyState" RENAME TO "GalaxyState";
CREATE TABLE "new_Planet" (
    ...
    "autoExiles" INTEGER NOT NULL DEFAULT 3,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "Planet_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Planet" ("carbonum", "createdAt", "createdTick", "fleetSlots", "galaxy", "id", "metalium", "name", "plutonium", "prodMul", "researchTier", "roidCarbonum", "roidMetalium", "roidPlutonium", "roider1", "roider2", "shipCaca", "shipCorveta", "shipCruzador", "shipDestroyer", "shipFragata", "shipNavemae", "slot", "system", "tech", "travelMul", "units", "userId") SELECT "carbonum", "createdAt", "createdTick", "fleetSlots", "galaxy", "id", "metalium", "name", "plutonium", "prodMul", "researchTier", "roidCarbonum", "roidMetalium", "roidPlutonium", "roider1", "roider2", "shipCaca", "shipCorveta", "shipCruzador", "shipDestroyer", "shipFragata", "shipNavemae", "slot", "system", "tech", "travelMul", "units", "userId" FROM "Planet";
DROP TABLE "Planet";
