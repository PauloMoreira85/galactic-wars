...
CREATE TABLE "new_Planet" (
    ...
    "name" TEXT NOT NULL,
    "preposition" TEXT NOT NULL DEFAULT 'de',
...
INSERT INTO "new_Planet" ("autoExiles", "carbonum", "createdAt", "createdTick", "fleetSlots", "galaxy", "id", "metalium", "name", "plutonium", "prodMul", "researchTier", "roidCarbonum", "roidMetalium", "roidPlutonium", "roider1", "roider2", "shipCaca", "shipCorveta", "shipCruzador", "shipDestroyer", "shipFragata", "shipNavemae", "slot", "system", "tech", "travelMul", "units", "userId") SELECT "autoExiles", "carbonum", "createdAt", "createdTick", "fleetSlots", "galaxy", "id", "metalium", "name", "plutonium", "prodMul", "researchTier", "roidCarbonum", "roidMetalium", "roidPlutonium", "roider1", "roider2", "shipCaca", "shipCorveta", "shipCruzador", "shipDestroyer", "shipFragata", "shipNavemae", "slot", "system", "tech", "travelMul", "units", "userId" FROM "Planet";
DROP TABLE "Planet";
