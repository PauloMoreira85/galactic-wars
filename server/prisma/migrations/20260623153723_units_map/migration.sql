...
INSERT INTO "new_Planet" ("carbonum", "createdAt", "galaxy", "id", "metalium", "name", "plutonium", "prodMul", "researchTier", "roidCarbonum", "roidMetalium", "roidPlutonium", "roider1", "roider2", "shipCaca", "shipCorveta", "shipCruzador", "shipDestroyer", "shipFragata", "shipNavemae", "slot", "system", "tech", "travelMul", "userId") SELECT "carbonum", "createdAt", "galaxy", "id", "metalium", "name", "plutonium", "prodMul", "researchTier", "roidCarbonum", "roidMetalium", "roidPlutonium", "roider1", "roider2", "shipCaca", "shipCorveta", "shipCruzador", "shipDestroyer", "shipFragata", "shipNavemae", "slot", "system", "tech", "travelMul", "userId" FROM "Planet";
DROP TABLE "Planet";
