-- AlterTable
ALTER TABLE "BuildOrder" ADD COLUMN "targetLevel" INTEGER;
ALTER TABLE "BuildOrder" ADD COLUMN "techKey" TEXT;
...
INSERT INTO "new_Planet" ("carbonum", "createdAt", "galaxy", "id", "metalium", "name", "plutonium", "researchTier", "roidCarbonum", "roidMetalium", "roidPlutonium", "shipCaca", "shipCorveta", "shipCruzador", "shipDestroyer", "shipFragata", "shipNavemae", "slot", "system", "userId") SELECT "carbonum", "createdAt", "galaxy", "id", "metalium", "name", "plutonium", "researchTier", "roidCarbonum", "roidMetalium", "roidPlutonium", "shipCaca", "shipCorveta", "shipCruzador", "shipDestroyer", "shipFragata", "shipNavemae", "slot", "system", "userId" FROM "Planet";
DROP TABLE "Planet";
